...
///   Version           : 1.06
///
//   Website: http://www.thedelphigeek.com/2014/12/attribute-based-command-line-parsing.html
///
///</para><para>
///   History:
///     1.06: 2025-09-13
  ...
  for data in FSwitchList do
    if soPositional in data.Options then begin
      ...
      if not (soRequired in data.Options) then
        hasOptional := true  // Fix: Flag optional parameter as being optional
...
begin { TGpCommandLineParser.ProcessAttributes }
  ...
  // Fix: Prevent crash when processing object properties without attributes
